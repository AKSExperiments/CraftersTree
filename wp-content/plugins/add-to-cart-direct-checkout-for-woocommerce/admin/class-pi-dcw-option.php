...
class Class_Pi_Dcw_Option{
    ...
    function __construct($plugin_name){
        ...
        $this->settings = array(
            ...
            array('field'=>'pi_dcw_allowed_hosts','desc'=>'enter domain name where you will redirect them after add to cart, if domain name is not in this list then it wont redirect to that external domain, make sure to enter one domain per line without http or https<br>E.g:<br> piwebsolution.com<br>google.com<br>yahoo.com', 'label'=>__('External Safe domain list where you want to redirect','pi-dcw'),'type'=>'textarea','default'=>"",'placeholder'=>'piwebsolution.com<br>google.com', 'pro'=>true),
