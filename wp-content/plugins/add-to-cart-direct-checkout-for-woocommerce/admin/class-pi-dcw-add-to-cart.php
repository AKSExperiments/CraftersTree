...
class Class_Pi_Dcw_AddToCart{
    ...
    function __construct($plugin_name){
        ...
        $this->settings = array(
            array('field'=>'sunday', 'class'=> 'bg-secondary text-light', 'class_title'=>'text-light font-weight-light h4', 'label'=>__('Add to Cart button','pisol-dtt'), 'type'=>'setting_category'),
            array('field'=>'pi_dcw_change_add_to_cart','desc'=>'Do you want to change the button text of add to cart button', 'label'=>__('Change Add to cart button text','pi-dcw'),'type'=>'switch', 'default'=>0),
            array('field'=>'pi_dcw_add_to_cart_text','desc'=>'This text will be shown inside add to cart button', 'label'=>__('Add to cart button text','pi-dcw'),'type'=>'text', 'default'=>__('Add to cart', 'woocommerce')),
