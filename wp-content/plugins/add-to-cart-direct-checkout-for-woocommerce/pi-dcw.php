...
if(pi_dcw_pro_check()){
    ...
    function pi_dcw_pro_error_notice() {
        ...
        <div class="error notice">
            <p><?php _e( 'You have pro version of add to cart redirect active please deactivate the pro version first and then activate free version', 'pi-edd' ); ?></p>
        </div>
        <?php
    }
...
function pisol_dcw_plugin_link( $links ) {
	$links = array_merge( array(
        ...
        '<a style="color:#0a9a3e; font-weight:bold;" target="_blank" href="' . esc_url(PI_DCW_BUY_URL) . '">' . __( 'Buy PRO Version' ) . '</a>'
	), $links );
	return $links;
}
