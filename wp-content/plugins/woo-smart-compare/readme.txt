...
- Hide/show attributes for a clearer view in comparison table
- WPML integration for building multilingual sitesCompare button advanced settings: type, text, visibility, categories, product removal
...
- Lifetime update & premium support
- Support customization of all attributes (Premium only)
- Support customization of all product fields, custom fields (Premium only)
- HOT: Free support of compare button’s adjustment to customers’ theme design (Premium only)
